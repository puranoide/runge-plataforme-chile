...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <?php
             include_once('../../../partials/egresospartials/menucomponent.php');
            ?>
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <?php include_once('../../../partials/egresospartials/usercomponent.php');?>
                <!-- End of Topbar -->

                <!-- Begin Page Content -->
                <div class="container-fluid">

                    <form action="../../../reroute/egreso/agregarRedirectegresomanual.php" method="POST">


                        <div data-mdb-input-init class="form-outline form-white mb-4">
                            <label class="form-label text-dark" for="linkFoto">Descripción del egreso</label>
                            <input type="text" id="linkFoto" class="form-control form-control-lg" name="descripcionegresoManual" required pattern="\S.*" />
